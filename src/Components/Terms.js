...
export default function Terms() {
    return (
        <div className="bg">
            <h3 className="heading">Terms and Conditions for Courseoverflow</h3>
            <p className="paragraph">
                <h4>Introduction</h4>
                These Website Standard Terms and Conditions written on this webpage shall manage your use of our website, Webiste Name accessible at courseoverflow.com. These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed to accept all terms and conditions written in here. You must not use this Website if you disagree with any of these Website Standard Terms and Conditions.

               <h4>Intellectual Property Rights</h4>
                Other than the content you own, under these Terms, Courseoverflow and/or its licensors own all the intellectual property rights and materials contained in this Website. You are granted limited license only for purposes of viewing the material contained on this Website.
                <br></br>
                <h4>Restrictions</h4>
